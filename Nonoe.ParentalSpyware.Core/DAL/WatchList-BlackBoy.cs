...
namespace Nonoe.ParentalSpyware.Core.DAL
{
    ...
    public class WatchList
    {
        ...
        public bool AddToWatchlist(string word)
        {
        ...
        {
            using (this.sqlCon = new SQLiteConnection(this.ConnectionString))
            {
                this.sqlCon.Open();
        ...
        /// <summary>
        /// Returns the connection string for the SQL Lite database.
        /// </summary>
